...
```{r setup-tibble}
team_data <- tibble(
  name = c("Herman Songe-Aakre", "Abdulrahman Albinali", "member 2", 
           "member 3", "member 4"),
  github_username = c("hermansokr", "7aman4013", "username 2", 
                      "username 3", "username 4"), 
  colour = c("green", "blue", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("drawing", "math/coding", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(7, 2, NA, NA, NA)
  )
